        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3.5">
          ...
          >
            <div className="flex items-center justify-between text-gray-500 mb-2">
              ...
              <span className="text-[10px] font-bold text-gray-400">Orders 🛍️</span>
            </div>
            <div className="flex items-center gap-3">
              ...
              <div className="min-w-0">
                ...
                <p className="text-xs text-gray-500 mt-1 font-medium leading-none">All Channels</p>
              </div>
            </div>
          </div>
          ...
          >
            <div className="flex items-center justify-between text-gray-500 mb-2">
              <span className="text-[11px] font-bold uppercase tracking-wider text-gray-500">VERIFY</span>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="min-w-0">
                <h3 className="text-2xl font-bold font-mono text-gray-900 tracking-tight leading-none">
                  {tabCounts.pending_verification}
                </h3>
                <p className="text-xs text-gray-500 mt-1 font-medium leading-none">Pending Verification</p>
              </div>
            </div>
          </div>
          ...
          >
            <div className="flex items-center justify-between text-gray-500 mb-2">
              <span className="text-[11px] font-bold uppercase tracking-wider text-gray-500">CONFIRM</span>
              <span className="text-[10px] font-bold text-blue-600">Dispatch</span>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl bg-blue-50 border border-blue-100 flex items-center justify-center text-blue-600 shrink-0">
              ...
              <div className="min-w-0">
                <h3 className="text-2xl font-bold font-mono text-gray-900 tracking-tight leading-none">
                  {tabCounts.pending_dispatch}
                </h3>
                <p className="text-xs text-gray-500 mt-1 font-medium leading-none">Awaiting Dispatch</p>
              </div>
            </div>
          </div>
          ...
          >
            <div className="flex items-center justify-between text-gray-500 mb-2">
              <span className="text-[11px] font-bold uppercase tracking-wider text-gray-500">IN TRANSIT</span>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="min-w-0">
                ...
                <p className="text-xs text-gray-500 mt-1 font-medium leading-none">Out with Courier</p>
              </div>
            </div>
          </div>
          ...
          >
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="min-w-0">
                ...
                <p className="text-xs text-gray-500 mt-1 font-medium leading-none">Delivered to Client</p>
              </div>
            </div>
          </div>
          ...
          >
            <div className="flex items-center justify-between text-gray-500 mb-2">
              <span className="text-[11px] font-bold uppercase tracking-wider text-gray-500">CANCELLED</span>
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="min-w-0">
                ...
                <p className="text-xs text-gray-500 mt-1 font-medium leading-none">Cancelled / RTO</p>
              </div>
            </div>
          </div>
        </div>
